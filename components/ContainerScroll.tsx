...
export const ContainerScroll = ({
  ...
  return (
    <div
      ...
      className="h-[80rem] flex justify-center relative lg:p-20 xl:p-0"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    ...
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-gray-100 md:rounded-2xl md:px-4 md:py-8">
        {children}
      </div>
    </motion.div>
  );
