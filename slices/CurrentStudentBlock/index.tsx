  ...
  return (
    ...
    >
      <div className="container">
        ...
        {/* <div className="grid grid-cols-1 lg:grid-cols-[30%_1fr] gap-16 my-4">
          {slice.primary.students.map((item, index) => (
            <>
              <div className="space-y-1" key={index}>
                <PrismicNextImage
                  field={item.image}
                  className="shadow-lg border-6 md:border-9 border-white rounded-3xl overflow-hidden"
                />
                <h3 className="text-2xl font-medium">{item.name}</h3>
                <p className="text-black/50 text-[1rem]">
                  {item.graduation_year}
                </p>
              </div>
              <p className="res-text">{item.biography}</p>
            </>
          ))}
        </div> */}
        <>
                ...
                <div className="flex gap-4 flex-col w-full">
                  ...
                  <div className="flex justify-between items-center">
                    <div className="">
                      ...
                      <motion.p className="text-[1rem]">{card.graduation_year}</motion.p>
                    </div>
